...
public class ScopusEmailValidator {
  ...
  public static final String INVALID_SPF_HEADERS_IN_EMAIL_ERROR_MESSAGE =
      "Invalid spf headers in email";
  public static final String WRONG_SUBJECT_RECEIVED_S_SHOULD_HAVE_BEEN_MESSAGE =
      "Wrong subject received: {}, " + "should have been: {}";
  ...
  private boolean wrongSubject(Message email) {
    ...
    if (invalidSubject) {
      LOGGER.error(
          WRONG_SUBJECT_RECEIVED_S_SHOULD_HAVE_BEEN_MESSAGE, email.getSubject(), VALID_SUBJECT);
    }
